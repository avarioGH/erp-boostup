const fs = require('fs');
let code = fs.readFileSync('frontend/src/app/inventory/trimming/[id]/page.tsx', 'utf-8');
...
fs.writeFileSync('frontend/src/app/inventory/trimming/[id]/page.tsx', code);
console.log('Trimming Detail updated');
