...
const oldRef = "export type ReferenceType = 'OPENING_BALANCE' | 'PRODUCTION_OUTPUT' | 'PRODUCTION_PROCESS_INPUT' | 'PRODUCTION_PROCESS_OUTPUT' | 'PRODUCTION_PROCESS_REVERSAL' | 'ADJUSTMENT_IN' | 'ADJUSTMENT_OUT' | 'TRANSFER_IN' | 'TRANSFER_OUT' | 'REVERSAL' | 'SALES_DELIVERY';";
