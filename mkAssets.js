const fs = require('fs');
fs.mkdirSync('frontend/src/app/finance/assets', { recursive: true });
...
fs.writeFileSync('frontend/src/app/finance/assets/page.tsx', content);
console.log('Created /finance/assets/page.tsx');
