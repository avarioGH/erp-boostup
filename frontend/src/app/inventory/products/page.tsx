...
export default function ProductInventory() {
 ...
 <div className="text-xs text-muted-foreground mt-1">Maks 8 foto. PNG, JPG (Otomatis dikompres)</div>
 </div>
 </label>
 </div>
 ...
 <div className="p-4 border-b border-border/60 flex flex-col sm:flex-row gap-4 justify-between bg-muted/30/50 dark:bg-[#0F172A]/50">
 ...
 <div className="flex items-center gap-2">
 <DropdownMenu>
 <DropdownMenuTrigger className="inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors border border-border bg-background shadow-sm hover:bg-muted/50 dark:hover:bg-slate-800 h-9 px-3 gap-2 outline-none">
 ...
 <span className={`font-semibold ${stock < 10 ? 'text-rose-600 dark:text-rose-400' : 'text-foreground'}`}>
 {stock}
 </span>
 </TableCell>
 );
