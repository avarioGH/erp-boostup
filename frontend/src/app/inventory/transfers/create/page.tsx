...
export default function CreateTransferPage() {
 ...
 <div>
 <h1 className="text-[28px] font-bold tracking-tight text-foreground">Create Stock Transfer</h1>
 ...
 {form.fromLocationId && (
 <Card className="shadow-sm">
 <CardHeader className="border-b bg-muted/10 pb-4"><CardTitle className="text-[16px] font-semibold">Select Item</CardTitle></CardHeader>
 <CardContent className="pt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
 ...
 <Button type="submit" disabled={submitting || !form.fromLocationId || !form.toLocationId || !item.timberVariantId || qty <= 0 || qty > (selectedStock?.currentPcs || 0)} className="w-full h-12 text-lg">
