...
export default function MovementsPage() {
  ...
  return (
    <div className="space-y-6 pb-10 p-8 dark">
      ...
      <Card className="shadow-sm bg-[#0f172a] border-slate-800 text-white">
          ...
          {loading ? (
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody>
                  {data.length === 0 ? (
                    <tr><td colSpan={6} className="text-center p-12 text-slate-500">No movements found.</td></tr>
                  ) : data.map((m, i) => {
                    ...
                    return (
                      <tr key={m.id || i} className="border-b border-slate-800/50 hover:bg-slate-800/20">
