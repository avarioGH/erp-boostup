...
export default function OrderRealizationReport() {
 ...
 <th colSpan={3} className="border border-border p-2 text-center">DIMENSIONS</th>
 <th colSpan={2} className="border border-border p-2 text-center bg-blue-50">ORDER</th>
 <th colSpan={2} className="border border-border p-2 text-center bg-emerald-50">REALISASI</th>
 <th colSpan={2} className="border border-border p-2 text-center bg-amber-50">SISA</th>
 </tr>
 <tr className="bg-muted/30 text-foreground">
 <th className="border border-border p-2">Customer</th>
 <th className="border border-border p-2">Order No</th>
 <th className="border border-border p-2">Tbl</th>
 <th className="border border-border p-2">Lbr</th>
 <th className="border border-border p-2">Pjg</th>
 <th className="border border-border p-2 bg-blue-50">Qty</th>
 <th className="border border-border p-2 bg-blue-50">M3</th>
 <th className="border border-border p-2 bg-emerald-50">Qty</th>
 <th className="border border-border p-2 bg-emerald-50">M3</th>
 <th className="border border-border p-2 bg-amber-50">Qty</th>
 <th className="border border-border p-2 bg-amber-50">M3</th>
 </tr>
 </thead>
 <tbody>
 {data.length === 0 ? (
 ...
 <td className="border border-border p-2">{row.customerName}</td>
 <td className="border border-border p-2">{row.orderNumber}</td>
 <td className="border border-border p-2 text-right">{row.thicknessMm}</td>
 <td className="border border-border p-2 text-right">{row.widthMm}</td>
 <td className="border border-border p-2 text-right">{row.lengthMm}</td>
