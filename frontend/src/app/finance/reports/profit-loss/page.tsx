...
export default function ProfitLossPage() {
 ...
 <p className="text-muted-foreground text-sm">Profit & Loss Statement berdasarkan transaksi dicatat</p>
 </div>
 ...
 {data?.expenses?.length === 0 && <p className="text-sm text-muted-foreground italic">Belum ada transaksi pengeluaran.</p>}
 </div>
