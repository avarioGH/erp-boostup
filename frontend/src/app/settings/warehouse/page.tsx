...
export default function WarehouseSettings() {
 ...
 <TableHead className="font-semibold text-foreground">Nama Gudang / Cabang</TableHead>
 <TableHead className="font-semibold text-foreground">Lokasi / Alamat</TableHead>
