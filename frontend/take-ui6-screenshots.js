...
(async () => {
  ...
  const routes = [
    { name: 'shipment-list', url: '/inventory/shipment' },
    { name: 'shipment-create', url: '/inventory/shipment/create' },
    { name: 'shipment-detail', url: '/inventory/shipment/err-mock' }
  ];
  ...
  await browser.close();
  console.log('UI-6 screenshots taken!');
})();
