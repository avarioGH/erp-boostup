const fs = require('fs');
fs.mkdirSync('frontend/src/app/approvals', { recursive: true });
...
fs.writeFileSync('frontend/src/app/approvals/page.tsx', content);
console.log('Created /approvals/page.tsx');
