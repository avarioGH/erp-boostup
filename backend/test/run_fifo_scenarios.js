...
async function runAll() {
  ...
  try {
    // Force collection creation so we can index it
    await prisma.journalEntry.create({ data: { company_id: 'temp', journal_no: 'temp', date: new Date(), description: 'temp', total_debit: 0, total_credit: 0 }});
    ...
    await prisma.$transaction(async tx => {
      ...
      // Product price is 50000. 30 * 50000 = 1,500,000. FIFO is 30 * 10000 = 300,000
