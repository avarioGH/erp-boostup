...
async function runAll() {
  ...
  try {
    ...
    // In MongoDB, we don't strictly need parents if we just insert the child collections that fifo.engine touches!
    // fifo.engine touches: InventoryCostLayer, CostLayerConsumption, StockMovement.
