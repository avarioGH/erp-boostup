...
async function bootstrap() {
  ...
  await prisma.product.create({ data: { id: prodId, company_id: c1, code: 'CERT-01', name: 'Certification Product', unit_id: unitId, purchase_price: 10000, selling_price: 15000 } });
  ...
  await prisma.role.create({ data: { id: roleHrId, company_id: c1, name: 'HR Only' }});
