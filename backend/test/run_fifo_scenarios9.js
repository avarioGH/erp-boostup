...
async function runAll() {
  ...
  try {
    ...
    const tA1 = '600000000000000000000101'; const tA2 = '600000000000000000000102';
    const tB1 = '600000000000000000000111'; const tB2 = '600000000000000000000112'; const tB3 = '600000000000000000000113';
    const tC1 = '600000000000000000000121'; const tC2 = '600000000000000000000122';
    const tD1 = '600000000000000000000131'; const tD2 = '600000000000000000000132';
    const tE1 = '600000000000000000000141'; const tE2 = '600000000000000000000142';
    const tF1 = '600000000000000000000151'; const tF2 = '600000000000000000000152'; const tF3 = '600000000000000000000153';
    const tK1 = '600000000000000000000161'; const tK2 = '600000000000000000000162'; const tK3 = '600000000000000000000163';
    const tU1 = '600000000000000000000171'; const tU2 = '600000000000000000000172';
    ...
    await prisma.$transaction(async tx => {
      const m1 = await tx.stockMovement.create({ data: { company_id: c1, warehouse_id: w1, product_id: p1, transaction_type: 'IN', transaction_id: tA1, movement_type: 'IN', qty_in: 100, qty_out: 0, balance_after: 100, unit_cost: 10000, total_cost: 1000000, created_by: sys }});
      await createFifoLayer(tx, { companyId: c1, productId: p1, warehouseId: w1, quantity: 100, unitCost: 10000, stockMovementId: m1.id });
      const m2 = await tx.stockMovement.create({ data: { company_id: c1, warehouse_id: w1, product_id: p1, transaction_type: 'OUT', transaction_id: tA2, movement_type: 'OUT', qty_in: 0, qty_out: 30, balance_after: 70, unit_cost: 0, total_cost: 0, created_by: sys }});
    ...
    await reset();
    await prisma.$transaction(async tx => {
      const m1 = await tx.stockMovement.create({ data: { company_id: c1, warehouse_id: w1, product_id: p1, transaction_type: 'IN', transaction_id: tB1, movement_type: 'IN', qty_in: 100, qty_out: 0, balance_after: 100, unit_cost: 10000, total_cost: 1000000, created_by: sys }});
      await createFifoLayer(tx, { companyId: c1, productId: p1, warehouseId: w1, quantity: 100, unitCost: 10000, stockMovementId: m1.id });
      const m2 = await tx.stockMovement.create({ data: { company_id: c1, warehouse_id: w1, product_id: p1, transaction_type: 'IN', transaction_id: tB2, movement_type: 'IN', qty_in: 100, qty_out: 0, balance_after: 200, unit_cost: 12000, total_cost: 1200000, created_by: sys }});
      await createFifoLayer(tx, { companyId: c1, productId: p1, warehouseId: w1, quantity: 100, unitCost: 12000, stockMovementId: m2.id });
      const m3 = await tx.stockMovement.create({ data: { company_id: c1, warehouse_id: w1, product_id: p1, transaction_type: 'OUT', transaction_id: tB3, movement_type: 'OUT', qty_in: 0, qty_out: 150, balance_after: 50, unit_cost: 0, total_cost: 0, created_by: sys }});
    ...
    await reset();
    await prisma.$transaction(async tx => {
      const m1 = await tx.stockMovement.create({ data: { company_id: c1, warehouse_id: w1, product_id: p1, transaction_type: 'IN', transaction_id: tC1, movement_type: 'IN', qty_in: 100, qty_out: 0, balance_after: 100, unit_cost: 10000, total_cost: 1000000, created_by: sys }});
      await createFifoLayer(tx, { companyId: c1, productId: p1, warehouseId: w1, quantity: 100, unitCost: 10000, stockMovementId: m1.id });
      const m2 = await tx.stockMovement.create({ data: { company_id: c1, warehouse_id: w1, product_id: p1, transaction_type: 'OUT', transaction_id: tC2, movement_type: 'OUT', qty_in: 0, qty_out: 100, balance_after: 0, unit_cost: 0, total_cost: 0, created_by: sys }});
    ...
    try {
      await prisma.$transaction(async tx => {
        const m1 = await tx.stockMovement.create({ data: { company_id: c1, warehouse_id: w1, product_id: p1, transaction_type: 'IN', transaction_id: tD1, movement_type: 'IN', qty_in: 100, qty_out: 0, balance_after: 100, unit_cost: 10000, total_cost: 1000000, created_by: sys }});
        await createFifoLayer(tx, { companyId: c1, productId: p1, warehouseId: w1, quantity: 100, unitCost: 10000, stockMovementId: m1.id });
        const mOut = await tx.stockMovement.create({ data: { company_id: c1, warehouse_id: w1, product_id: p1, transaction_type: 'OUT', transaction_id: tD2, movement_type: 'OUT', qty_in: 0, qty_out: 101, balance_after: -1, unit_cost: 0, total_cost: 0, created_by: sys }});
      ...
      results.D_INSUFFICIENT = (layers.length === 1 && layers[0].remaining_quantity === 100) ? 'PASS' : 'FAIL_ROLLBACK_FAILED';
    }

    await reset();
    await prisma.$transaction(async tx => {
      const m1 = await tx.stockMovement.create({ data: { company_id: c1, warehouse_id: w1, product_id: p1, transaction_type: 'IN', transaction_id: tE1, movement_type: 'IN', qty_in: 100, qty_out: 0, balance_after: 100, unit_cost: 10000, total_cost: 1000000, created_by: sys }});
      await createFifoLayer(tx, { companyId: c1, productId: p1, warehouseId: w1, quantity: 100, unitCost: 10000, stockMovementId: m1.id });
      const m2 = await tx.stockMovement.create({ data: { company_id: c1, warehouse_id: w1, product_id: p1, transaction_type: 'OUT', transaction_id: tE2, movement_type: 'OUT', qty_in: 0, qty_out: 40, balance_after: 60, unit_cost: 0, total_cost: 0, created_by: sys }});
    ...
    await reset();
    const mCon1 = await prisma.stockMovement.create({ data: { company_id: c1, warehouse_id: w1, product_id: p1, transaction_type: 'IN', transaction_id: tK1, movement_type: 'IN', qty_in: 100, qty_out: 0, balance_after: 100, unit_cost: 10000, total_cost: 1000000, created_by: sys }});
    ...
    const tx1 = prisma.$transaction(async tx => {
      const mOut = await tx.stockMovement.create({ data: { company_id: c1, warehouse_id: w1, product_id: p1, transaction_type: 'OUT', transaction_id: tK2, movement_type: 'OUT', qty_in: 0, qty_out: 80, balance_after: 20, unit_cost: 0, total_cost: 0, created_by: sys }});
    ...
    const tx2 = prisma.$transaction(async tx => {
      const mOut = await tx.stockMovement.create({ data: { company_id: c1, warehouse_id: w1, product_id: p1, transaction_type: 'OUT', transaction_id: tK3, movement_type: 'OUT', qty_in: 0, qty_out: 80, balance_after: 20, unit_cost: 0, total_cost: 0, created_by: sys }});
      return await consumeFifoLayers(tx, { companyId: c1, productId: p1, warehouseId: w1, quantity: 80, stockMovementId: mOut.id });
    });
    ...
    await reset();
    await prisma.$transaction(async tx => {
      const m1 = await tx.stockMovement.create({ data: { company_id: c1, warehouse_id: w1, product_id: p1, transaction_type: 'IN', transaction_id: tU1, movement_type: 'IN', qty_in: 100, qty_out: 0, balance_after: 100, unit_cost: 10000, total_cost: 1000000, created_by: sys }});
      await createFifoLayer(tx, { companyId: c1, productId: p1, warehouseId: w1, quantity: 100, unitCost: 10000, stockMovementId: m1.id });
      const m2 = await tx.stockMovement.create({ data: { company_id: c1, warehouse_id: w1, product_id: p1, transaction_type: 'OUT', transaction_id: tU2, movement_type: 'OUT', qty_in: 0, qty_out: 30, balance_after: 70, unit_cost: 0, total_cost: 0, created_by: sys }});
      const { totalCogs } = await consumeFifoLayers(tx, { companyId: c1, productId: p1, warehouseId: w1, quantity: 30, stockMovementId: m2.id });
